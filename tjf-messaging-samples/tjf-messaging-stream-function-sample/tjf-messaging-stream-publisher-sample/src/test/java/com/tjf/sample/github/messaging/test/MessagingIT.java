...
@SpringBootTest(classes = { PublisherApplication.class }, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
public abstract class MessagingIT {

	public static final String ARRIVED_URL = "/starship/arrived";
	public static final String ARRIVED_WITHOUT_TENANT = "/starship/arrived-it";
