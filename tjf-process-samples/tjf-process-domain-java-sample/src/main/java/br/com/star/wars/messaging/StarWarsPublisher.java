...
import com.totvs.tjf.process.core.CreateTenantCommand;
import com.totvs.tjf.process.core.ProcessContext;
...
public class StarWarsPublisher {
    ...
    public void createTenant() {
    	...
    	TOTVSMessage <CreateTenantCommand> message = 
    			new TOTVSMessage <CreateTenantCommand> ("CreateTenantCommand", new CreateTenantCommand());
    ...
    public void dispatch(final QuiGonFoundAnakinEvent event) {
    	...
    	TOTVSMessage <QuiGonFoundAnakinEvent> message = new TOTVSMessage <QuiGonFoundAnakinEvent> ("QuiGonFoundAnakinEvent", event);
    	message.sendTo(exchange.output());
    ...
    public void dispatch(final BecomeDarthVaderEvent event) {
    	...
    	new ProcessMessage <BecomeDarthVaderEvent> ("BecomeDarthVaderEvent", context)
    		.with(event)
    		.sendTo(exchange.output());
    ...
    public void dispatch(final VisitDeathStarEvent event) {
    	...
    	new ProcessMessage <VisitDeathStarEvent> ("VisitDeathStarEvent", context)
    		.with(event)
    		.sendTo(exchange.output());
    ...
    public void dispatch(final RevealToLukeEvent event) {
    	...
    	new ProcessMessage <RevealToLukeEvent> ("RevealToLukeEvent", context)
    		.with(event)
    		.sendTo(exchange.output());
    ...
    public void dispatch(final FightWithLukeEvent event) {
    	...
    	new ProcessMessage <FightWithLukeEvent> ("FightWithLukeEvent", context)
    		.with(event)
    		.sendTo(exchange.output());
